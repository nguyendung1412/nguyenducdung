        ...
        if($data['booking_status'] == 'Đã Đặt'){
          ...
          <div class='col-md-4 px-4 mb-4'>
            <div class='bg-white p-3 rounded shadow-sm'>
              ...
              action="momo_qr.php">
              <input type="hidden" value="$toltal" name ="toltal1">
              <input type="submit" name="momo" value="Thanh toán qua QR CODE" class="btn btn-danger"/>
              </form>
              ...
              action="momo_atm.php">
              <input type="hidden" value="$toltal" name ="toltal1">
              <input type="submit" name="momo" value="Thanh toán qua MOMO ATM" class="btn btn-danger"/>
              </form>
            </div>
          </div>
          bookings;

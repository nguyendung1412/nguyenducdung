...
<body class="bg-light">
  ...
  <div class="my-5 px-4">
    ...
    Khách sạn Hà Nội cam kết mang đến cho khách hàng những trải nghiệm<br>
  ...
  <div class="container">
    <div class="row justify-content-between align-items-center">
      <div class="col-lg-6 col-md-5 mb-4 order-lg-1 order-md-1 order-2">
        <h3 class="mb-3">Khách sạn HaNoi Hotel</h3>
        <p>
        Khách sạn HaNoi Hotel là một trong những khách sạn hàng đầu tại Việt Nam,
      ...
      <div class="col-lg-5 col-md-5 mb-4 order-lg-2 order-md-2 order-1">
        <img src="images/about/ht.jpg" class="w-100">
      </div>
    </div>
  </div>
